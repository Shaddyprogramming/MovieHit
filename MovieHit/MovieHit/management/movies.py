...
class Movies(models.Model):
    ...
    genres = models.JSONField(default="No genres", help_text="A list of genres associated with the movie.")
    age = models.CharField(max_length=50, default="No age", help_text="The age rating of the movie (e.g., PG-13).")
    directors = models.JSONField(default="No directors", help_text="A list of directors of the movie.")
    writers = models.JSONField(default="No writers", help_text="A list of writers of the movie.")
    actors = models.JSONField(default="No actors", help_text="A list of actors in the movie.")
